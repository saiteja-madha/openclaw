    ...
    <section ref={heroRef} className="hero">
      ...
      <div className="hero__container">
        <div className="hero__content">
          <span className="hero__greeting animate-in">Hello, I'm</span>
          
          <h1 className="hero__title animate-in">
            <span className="hero__name">Alex Developer</span>
          </h1>
          
          <h2 className="hero__subtitle animate-in">
            Full Stack Developer & UI/UX Enthusiast
          </h2>
          
          <p className="hero__description animate-in">
            I craft beautiful, responsive web experiences with modern technologies.
            Passionate about clean code, user-centric design, and building products 
          ...
          <div className="hero__socials animate-in">
